...
Phonewave stores its manifest in `.phonewave/config.yaml` (generated by `phonewave init`). Runtime state is tracked in `.phonewave/resolved.yaml`. See [docs/phonewave-directory.md](docs/phonewave-directory.md) for the full directory structure.
